...
module.exports = {
    chatgpt: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.chatgpt4, {
                prompt: args.join(' ')
            });
    ...
    trixie: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.trixie, {
                prompt: args.join(' ')
            });
            return response.data.response || 'No response received.';
        } catch (error) {
    ...
    dalle: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.dalle3, {
                prompt: args.join(' ')
            });
            return response.data.response || 'No image generated.';
        } catch (error) {
    ...
    blackbox: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.blackbox, {
                prompt: args.join(' ')
            });
            return response.data.response || 'No response received.';
        } catch (error) {
    ...
    gpt4: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.gpt4, {
                prompt: args.join(' ')
            });
            return response.data.response || 'No response received.';
        } catch (error) {
    ...
    deepseek: async (sender_id, args) => {
        ...
        try {
            const response = await axios.post(config.apis.deepseek, {
                prompt: args.join(' ')
            });
            return response.data.response || 'No response received.';
        } catch (error) {
